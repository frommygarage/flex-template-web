  ...
  return (
    <div className={classes}>
      ...
      <p>
        ...
        whether personally or on behalf of an entity (“you”) and FROM MY GARAGE LLC 
        ("Company", “we”, “us”, or “our”), concerning your access to and use of the 
        www.frommygarage.com website as well as any other media form, media channel, 
        mobile website or mobile application related, linked, or otherwise connected 
        thereto (collectively, the “Site”). You agree that by accessing the Site, 
        you have read, understood, and agreed to be bound by all of these Terms of Service. 
        IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF SERVICE, THEN YOU ARE EXPRESSLY PROHIBITED 
      ...
      <p>
        ...
        or country. Accordingly, those persons who choose to access the Site from other locations do 
        so on their own initiative and are solely responsible for compliance with local laws, if and 
      ...
      <p>
        ...
        are provided on the Site “AS IS” for your information and personal use only. Except as expressly provided 
        in these Terms of Service, no part of the Site and no Content or Marks may be copied, reproduced, aggregated, 
      ...
      <p>
        ...
        with these Terms of Service; (4) you are not a minor in the jurisdiction in which you reside; (5) you will 
        not access the Site through automated or non-human means, whether through a bot, script, or otherwise; (6) 
        you will not use the Site for any illegal or unauthorized purpose; and (7) your use of the Site will not 
      ...
      the Content contained therein.<br/>
      ...
      ith the use, features, functions, operation, or maintenance of the Site.<br/>
      11. Engage in any automated use of the system, such as using scripts to send comments or messages, or using any 
      data mining, robots, or similar data gathering and extraction tools.<br/>
      ...
      20. Decipher, decompile, disassemble, or reverse engineer any of the software comprising or in any way making up a 
      part of the Site.<br/>
      ...
      <p>
        ...
        or other material (collectively, "Contributions"). Contributions may be viewable by other users of the Site and 
        through third-party websites. As such, any Contributions you transmit may be treated as non-confidential and 
        non-proprietary. When you create or make available any Contributions, you thereby represent and warrant that:<br/>
        ...
        o the copyright, patent, trademark, trade secret, or moral rights of any third party.<br/>
        ...
        contemplated by the Site and these Terms of Service.<br/>
        ...
        enable inclusion and use of your Contributions in any manner contemplated by the Site and these Terms of Service.<br/>
        ...
        or otherwise objectionable (as determined by us).<br/>
        ...
        threaten physical harm against another.<br/>
        ...
        Terms of Service, or any applicable law or regulation.<br/>
      </p>       
      <p>
        Any use of the Site in violation of the foregoing violates these Terms of Service and may result in, 
...
<p>These Terms of Service and your use of the Site are governed by and construed in accordance with the laws of the State of Washington applicable to agreements made and to be entirely performed within the State of Washington, without regard to its conflict of law principles.</p>
...
<p>United States</p>
<p>loanitlikeyouownit@gmail.com</p>
